      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-warm-500 leading-relaxed max-w-md mb-6">
              Cafenea de specialitate și co-working space &icirc;n inima
              Bucureștiului. Fiecare ceașcă este o călătorie prin origine,
              meșteșug și pasiune. Ideas in Motion.
            </p>
            {/* Social */}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-warm-500">
              <li>Str. Gen. Traian Doda nr. 5</li>
              <li>Sector 2, București</li>
              <li className="pt-2">Lun&ndash;Mie: 08:00&ndash;19:00</li>
              <li>Joi&ndash;Vin: 08:00&ndash;21:00</li>
              <li>S&acirc;m&ndash;Dum: 09:00&ndash;21:00</li>
              <li className="pt-2">
                <a href="https://wa.me/40765472825" className="hover:text-warm-300 transition-colors">
        ...
        <div className="border-t border-warm-900 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-warm-700 text-xs">
            Creat cu drag &icirc;n București
          </p>
        </div>
      </div>
    </footer>
